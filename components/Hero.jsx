...
function Hero() {
  return (
    <div className="text-white   sm:pt-0   flex flex-col flex-nowrap relative  gap-[54px] justify-center z-0 overflow-visible">
      <div className=" flex flex-col pt-[60px]  px-[30px] max-w-[1200px] mx-auto sm:flex-shrink-0 justify-start">
        <p className=" font-Gallary text-[75px] sm:text-[120px]  leading-[0.8] text-white ">
        ...
        <p className=" hidden sm:block font-Inter font-[300] mt-[55px] text-[#9d78e8] sm:text-[44px] text-[33px] tracking-[-1.8px] leading-[1.5em] ">
          <span className="text-white text-[44px]">
