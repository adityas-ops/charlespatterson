  ...
  return (
    <div className="bg-black text-white ">
      ...
      <div className="fixed sm:block hidden z-[1000] right-[50px] bottom-[50px] w-[100px] h-[100px] bg-[#cccccc] rounded-[50%] p-[10px]">
            ...
            <text>
              <textPath
                ...
                style={{
                  ...
                  wordSpacing: 0,
                  letterSpacing: "6.1px",
                  fill: 'var(--token-b882507f-00b1-4ceb-a2ff-bc04610c539e, rgba(0, 0, 0, 0.8)) /* {"name":"Primary inverted"} */',
                }}
              >
        ...
        <div className=" w-[42px] h-[20px]  absolute top-[40%] left-[30%]">
          <img
          src="/images/infinite.svg"
